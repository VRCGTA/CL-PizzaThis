...
local multiplier = 2
Config.Thirst = {
    Champagne = 10 * multiplier,
    Beer = 3 * multiplier,
    RedWine = 5 * multiplier,
    WhiteWine = 5 * multiplier,
    PinkWine = 5 * multiplier,
    Whiskey = 6 * multiplier,
    GoldSake = 6 * multiplier,
    Rum = 2 * multiplier,
    WhiteWineBottle = 7 * multiplier,
    WhiskeyBottle = 7 * multiplier,
    WaterCup = 13 * multiplier,
    RedWineBottle = 16 * multiplier,
    SparklingBottle = 16 * multiplier,
    CastelloBrolioBottle = 16 * multiplier,
    GaryReffelBottle = 16 * multiplier,
    RutherfordHillBottle = 16 * multiplier,
    PinkWineBottle = 16 * multiplier,
    EspressoMacchiato = 8 * multiplier,
    CaramelFrappucino = 8 * multiplier,
    ColdbrewLatte = 8 * multiplier,
    StrawberryVanillaOatLatte = 8 * multiplier,
    CocaCola = 7 * multiplier,
    DRPepper = 7 * multiplier,
    Sprite = 7 * multiplier,
}
