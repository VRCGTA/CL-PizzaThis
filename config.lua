...
local multipier = 2
Config.Thirst = {
    Champagne = 10 * multipier,
    Beer = 3 * multipier,
    RedWine = 5 * multipier,
    WhiteWine = 5 * multipier,
    PinkWine = 5 * multipier,
    Whiskey = 6 * multipier,
    GoldSake = 6 * multipier,
    Rum = 2 * multipier,
    WhiteWineBottle = 7 * multipier,
    WhiskeyBottle = 7 * multipier,
    WaterCup = 13 * multipier,
    RedWineBottle = 16 * multipier,
    SparklingBottle = 16 * multipier,
    CastelloBrolioBottle = 16 * multipier,
    GaryReffelBottle = 16 * multipier,
    RutherfordHillBottle = 16 * multipier,
    PinkWineBottle = 16 * multipier,
    EspressoMacchiato = 8 * multipier,
    CaramelFrappucino = 8 * multipier,
    ColdbrewLatte = 8 * multipier,
    StrawberryVanillaOatLatte = 8 * multipier,
    CocaCola = 7 * multipier,
    DRPepper = 7 * multipier,
    Sprite = 7 * multipier,
}
